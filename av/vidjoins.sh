...
# PURP: Does video join simply                                         #
#                                                                      #
# vidjoins.sh joins videos simply and tends to work well if videos are #
# all the same format. Also, see vidjoinc.sh for a complex join which  #
...
ffmpeg -f concat -safe 0 -i $TP -c copy $BN.mp4
...
# works most of the time depending on situation, but should re-examine !!!
